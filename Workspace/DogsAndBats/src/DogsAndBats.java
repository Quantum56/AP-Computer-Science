/**
 * Program that outputs Dogs and Bats with certain parameters.
 */

/**
 * @authors ZackB, DavyA, AlexS.
 *
 */
public class DogsAndBats {
	...
	public static void main(String[] args) {
		...
		System.out.println(bat1Name + " is " + bat1Weight + " LBS and is " + bat1Color + ", and has " + bat1NumLegs + " legs.");
