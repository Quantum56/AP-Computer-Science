...
public class FractalGen extends JApplet {
	...
	public void init() {
		int X = Integer.parseInt(JOptionPane.showInputDialog("Enter the desired display X value: "));
		int Y = Integer.parseInt(JOptionPane.showInputDialog("Enter the desired display Y value: "));
		setSize(X, Y);
	...
	private void drawSnowflake(Graphics page, int lev, Point p1, Point p2, Point p3) {
		drawSegment(page, lev, p1, p2); // draw 3 lines to make a triangle
		drawSegment(page, lev, p2, p3);
		drawSegment(page, lev, p3, p1);
	}
